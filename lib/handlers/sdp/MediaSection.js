            ...
            case 'video':
                {
                    ...
                    for (const codec of answerRtpParameters.codecs) {
                        ...
                        if (codecOptions) {
                            const { opusStereo, opusFec, opusDtx, opusMaxPlaybackRate, opusPtime, opusMaxAverageBitrate, videoGoogleStartBitrate, videoGoogleMaxBitrate, videoGoogleMinBitrate } = codecOptions;
